...
void file_client_thread::execute()
{
	...
	udp_manager_ = new udp_manager(	this, bind_ip_, remote_ip_, remote_port_, session_, parent_->log_, delay_, delay_timer_);
...
void file_client_thread::reponse_config_fun(server_message_buffer *message_buffer)
{
	...
	//打开文件
	harq_file_handle file_handle = harq_create_file(absolute_path);
