...
//正在发送文件
*/
enum client_file_state{cfs_inited, cfs_configing, cfs_configed, cfs_sending};
...
//已经通知上层断开了连接
*/
enum client_state{ccs_inited, ccs_conneced, ccs_logined, ccs_disconnected, ccs_notify_disconnected};
