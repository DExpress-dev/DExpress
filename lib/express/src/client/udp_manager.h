...
public:
	...
	int send_config(const long long &size, const std::string &absolute_path_, const std::string &remote_path, std::string &file_name);
	int send_file_block(long long max, long long cur, char* data, int size);
