...
#include "interface.h"
	...
	EXPRESS_CLIENT_LIB bool send_dir(int express_handle, char* local_dir_path, char* remote_relative_path);
	...
	EXPRESS_CLIENT_LIB void stop_send(int express_handle, char* local_file_path);
	...
	extern "C"{
		...
		bool send_dir(int express_handle, char* local_dir_path, char* remote_relative_path);
		bool send_buffer(int express_handle, char* data, int size);
		int cur_waiting_size(int express_handle);
		void stop_send(int express_handle, char* local_file_path);
